...
import { Swiper as SwiperType } from "swiper"; // Swiper 타입을 가져옵니다.
		...
		<div className="container mx-auto px-4 relative">
			...
			<div className="relative overflow-visible my-[100px]">
				...
				>
					...
					<div className="swiper-button-next1 absolute right-0 top-1/2 -translate-y-1/2 p-2 hidden md:block">
						<svg
							width="48"
							height="48"
							viewBox="0 0 24 24"
					...
					<div className="swiper-button-prev1 absolute left-0 top-1/2 -translate-y-1/2 p-2 hidden md:block">
						<svg
							width="48"
							height="48"
							viewBox="0 0 24 24"
