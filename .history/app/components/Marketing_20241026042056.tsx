				...
				>
					{videos.map((video, index) => {
						...
						return (
							<SwiperSlide
								key={index}
								className="flex-shrink-0 w-full aspect-video transition-transform duration-300 ease-in-out m-1"
							>
								<iframe
					...
					<div className="swiper-button-next1 absolute right-0 top-1/2 -translate-y-1/2 p-2">
						<svg
							width="48"
							height="48"
							viewBox="0 0 24 24"
					...
					<div className="swiper-button-prev1 absolute left-0 top-1/2 -translate-y-1/2 p-2">
						<svg
							width="48"
							height="48"
							viewBox="0 0 24 24"
