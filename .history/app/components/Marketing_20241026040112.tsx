		...
		<div className="container mx-auto px-4 relative">
			...
			<div className="relative overflow-visible my-[100px]">
				...
				>
					...
					<div className="swiper-button-next bg-secondary text-white p-2 rounded-full shadow-lg hover:bg-secondary-dark transition duration-300 ease-in-out"></div>
					<div className="swiper-button-prev bg-secondary text-white p-2 rounded-full shadow-lg hover:bg-secondary-dark transition duration-300 ease-in-out"></div>
				</Swiper>
			</div>
		</div>
	);
