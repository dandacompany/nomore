		...
		<div className="flex flex-wrap justify-center text-center items-center h-[500px]">
			{subMenus.map((menu, index) => (
				<Link
					href={menu.link}
					key={index}
					className="flex-1 bg-secondary text-primary p-6 hover:bg-opacity-90 transition duration-300 flex flex-col items-center border-r border-tertiary-300 h-full"
				>
