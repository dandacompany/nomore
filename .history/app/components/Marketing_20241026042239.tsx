	...
	return (
		<div className="container mx-auto px-4 relative">
			...
			<div className="relative overflow-visible my-[100px]">
				...
				>
					{videos.map((video, index) => {
						...
						return (
							<SwiperSlide
								key={index}
								className={`flex-shrink-0 w-full aspect-video transition-transform duration-300 ease-in-out overflow-visible ${
				...
				<div
					className="swiper-button-next bg-secondary text-white p-2 rounded-full shadow-lg hover:bg-secondary-dark transition duration-300 ease-in-out"
					onClick={() => swiperRef.current?.slideNext()}
				>
					<FaArrowRight />
				</div>
				<div
					className="swiper-button-prev bg-secondary text-white p-2 rounded-full shadow-lg hover:bg-secondary-dark transition duration-300 ease-in-out"
