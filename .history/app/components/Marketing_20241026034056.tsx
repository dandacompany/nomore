...
const Marketing: React.FC = () => {
	...
	const videoArray = videos.slice(0, 3); // 첫 3개의 슬라이드만 사용
		...
		<div className="container mx-auto px-4 relative">
			...
			<div className="relative overflow-visible my-[100px]">
				<div
					...
					style={{ transform: `translateX(-${currentSlide * 33.33}%)` }} // 슬라이드 인덱스에 맞게 수정
				>
					{videoArray.map((video, index) => {
						...
						return (
							<div
								key={index}
								className={`min-w-full flex-shrink-0 w-full aspect-video transition-transform duration-300 ${
									isCurrent
