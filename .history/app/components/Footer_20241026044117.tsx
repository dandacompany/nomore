		...
		<footer className="bg-primary text-secondary py-10">
			<div className="container mx-auto px-4">
				<div className="flex flex-wrap justify-between">
					{/* 로고 및 회사 정보 */}
					<div className="w-full md:w-1/4 mb-6 md:mb-0 border-r border-secondary">
						<Link href="/">
							<Image
					...
					<div className="w-full md:w-3/4 p-10 flex flex-row gap-10 justify-between ">
						{/* 메뉴 링크 */}
						<div className="w-full mb-6 md:mb-0 p-10">
