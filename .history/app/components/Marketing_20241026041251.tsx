		...
		<div className="container mx-auto px-4 relative">
			...
			<div className="relative overflow-visible my-[100px]">
				...
				>
					...
					<div className="swiper-button-next bg-white text-red p-2 rounded-full border-2 border-black shadow-lg hover:bg-secondary-dark transition duration-300 ease-in-out">
						<FaArrowRight />
					</div>
					<div className="swiper-button-prev bg-white text-red p-2 rounded-full border-2 border-black shadow-lg hover:bg-secondary-dark transition duration-300 ease-in-out">
