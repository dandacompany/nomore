...
const FranchiseMarketing: React.FC = () => {
	return (
		<div className="flex flex-col">
			...
			<div className="mt-8">
				<h2 className="text-2xl font-bold text-red-500">Marketing</h2>
				...
				<table className="w-full mt-4 text-left border-collapse">
					<thead>
						<tr>
							<th className="border-b-2 border-gray-300 py-2">제목</th>
							<th className="border-b-2 border-gray-300 py-2">내용</th>
							<th className="border-b-2 border-gray-300 py-2">날짜</th>
						</tr>
					</thead>
					<tbody>
						{marketingData.items.map((item, index) => (
