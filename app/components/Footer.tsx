					...
					<div className="w-full md:w-2/3 py-10 pl flex flex-row gap-10 justify-between ">
						...
						<div className="w-full mb-6 md:mb-0 p-6">
							...
							<ul className="flex flex-col gap-4">
								<li>
									<Link href="/menu?category=전체메뉴">전체메뉴</Link>
								</li>
								<li>
									<Link href="/menu?category=떡볶이">떡볶이</Link>
								</li>
								<li>
									<Link href="/menu?category=사이드">사이드</Link>
								</li>
								<li>
									<Link href="/menu?category=토핑">토핑</Link>
								</li>
								<li>
									<Link href="/menu?category=세트">세트</Link>
								</li>
							</ul>
						</div>
						{/* 고객 지원 */}
						...
						<div className="w-full mb-6 md:mb-0 p-6">
							...
							<ul className="flex flex-col gap-4">
								<li>
									<Link href="/franchise">창업문의</Link>
								</li>
								<li>
									<Link href="/franchise?tab=창업절차">창업절차</Link>
								</li>
								<li>
									<Link href="/franchise?tab=창업비용 및 혜택">
										창업비용 및 혜택
									</Link>
								</li>
								<li>
									<Link href="/franchise?tab=마케팅 및 스페셜">
										마케팅 및 스페셜
									</Link>
								</li>
							</ul>
						...
						<div className="w-full mb-6 md:mb-0 p-6">
							...
							<ul className="flex flex-col gap-4">
								...
								<li>
									<Link href="/about#brand">CEO</Link>
								</li>
								<li>
									<Link href="/about#history">History</Link>
								</li>
								<li>
									<Link href="/about#awards">CI / BI</Link>
								</li>
							</ul>
						</div>
					</div>
